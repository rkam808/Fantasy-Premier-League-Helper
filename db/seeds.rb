...
Club.create(name:"Everton")
Club.create(name:"Arsenal")
Club.create(name:"Leeds United")
Club.create(name:"Aston Villa")
Club.create(name:"Wolverhampton Wanderers")
Club.create(name:"Crystal Palace")
Club.create(name:"Southampton")
Club.create(name:"Newcastle United")
Club.create(name:"Brighton")
Club.create(name:"Burnley")
Club.create(name:"Fulham")
Club.create(name:"West Brom")
Club.create(name:"Sheffield United")
